...
public class CommandFramework {
    ...
    public CommandFramework(Plugin plugin) {
        ...
        try {
            ...
            plugin.getLogger().severe("Could not retrieve the internal CommandMap. Dynamic command registration will fail.");
            throw new RuntimeException("Failed to initialize CommandFramework", e);
        }
    }
    ...
    private boolean handleCommand(CommandSender sender, String commandLabel, String[] args) {
        ...
        try {
            ...
            plugin.getLogger().severe("Exception in command '" + commandLabel + "':");
