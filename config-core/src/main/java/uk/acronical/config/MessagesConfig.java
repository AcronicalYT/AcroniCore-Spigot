...
public class MessagesConfig extends DefaultConfig {
    ...
    /**
     * Constructor for the MessagesConfig class, which extends the DefaultConfig class. This constructor initializes the MessagesConfig by calling the superclass constructor
     *
